...
public class postRoomStep4 extends Fragment implements View.OnClickListener {
    ...
    float width,length;
    int priceRomm,electricBill,warterBill,InternetBill,parkingBill;
    ...
    private void getDataFromPreference(){
        ...
        priceRomm = sharedpreferences.getInt(postRoomStep2.SHARE_RPICEROOM,0);
        electricBill = sharedpreferences.getInt(postRoomStep2.SHARE_ELECTRICB,0);
        warterBill = sharedpreferences.getInt(postRoomStep2.SHARE_WARTERB,0);
        InternetBill = sharedpreferences.getInt(postRoomStep2.SHARE_INTERNETB,0);
        parkingBill = sharedpreferences.getInt(postRoomStep2.SHARE_PARKINGB,0);
            ...
            case R.id.btn_nextStep4_post_room:
                ...
                if(checkTrueDataFromControl()==true){
                    ...
                    if(postRoom.isStepOneComplete()==true&postRoom.isStepTwoComplete()&&postRoom.isStepTreeComplete()){
                        ...
                        //Show dialog
                        progressDialog.setTitle("Đang đăng phòng....");
                        progressDialog.show();
                        btnNextStep4PostRoom.setEnabled(false);
                        btnNextStep4PostRoom.setBackgroundResource(R.drawable.custom_button_login);
                        btnNextStep4PostRoom.setText("Nhấn nút Back để quay về!");
