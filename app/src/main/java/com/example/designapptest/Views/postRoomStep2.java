...
public class postRoomStep2 extends Fragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void getDataFromControl(){
        ...
        priceRomm = Integer.parseInt(edtPriceRoomPushRoom.getText().toString());
        electricBill = Integer.parseInt(edtElectricBillPushRoom.getText().toString());
        warterBill = Integer.parseInt(edtWaterBillPushRoom.getText().toString());
        InternetBill = Integer.parseInt(edtInternetPushRoom.getText().toString());
        parkingBill = Integer.parseInt(edtParkingPushRoom.getText().toString());
    }
    ...
    private void saveDataToPreference(){
        ...
        editor.putInt(SHARE_RPICEROOM, priceRomm);
        editor.putInt(SHARE_ELECTRICB, electricBill);
        editor.putInt(SHARE_INTERNETB, InternetBill);
        editor.putInt(SHARE_WARTERB, warterBill);
        editor.putInt(SHARE_PARKINGB, parkingBill);
