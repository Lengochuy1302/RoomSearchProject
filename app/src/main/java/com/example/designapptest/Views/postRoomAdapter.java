...
public class postRoomAdapter extends AppCompatActivity implements ICallBackPostRoom, View.OnClickListener {// chưa test
    ...
    public void showNoInternetConnectionDialog(){
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(postRoomAdapter.this);
        builder.setMessage("Ôi không! người ngoài hành tinh đã cản trở kết nối của chúng ta, hãy kiểm tra và thử lại!")
                .setIcon(R.drawable.nointernet)
                .setTitle("Không có kết nối mạng !")
                .setCancelable(false)
                .setNeutralButton("Thử lại", new DialogInterface.OnClickListener() {
