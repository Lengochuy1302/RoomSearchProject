...
public class personalPage extends AppCompatActivity {
        ...
        chBoxEditPersonalPage.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ...
                    txtChangeAvtPersonalPage.setVisibility(View.VISIBLE);
                    txtPasswordPersonalPage.setVisibility(View.VISIBLE);
                    ...
                    SweetAlertDialog pDialog = new SweetAlertDialog(personalPage.this, SweetAlertDialog.PROGRESS_TYPE);
                    pDialog.getProgressHelper().setBarColor(Color.parseColor("#A5DC86"));
                    pDialog.setTitleText("Đang update");
                    ...
                    spnGenderPersonalPage.setEnabled(false);
                    txtChangeAvtPersonalPage.setVisibility(View.GONE);
                    txtPasswordPersonalPage.setVisibility(View.GONE);
                    ...
                    if(isChangeAvatar) {
                        StorageReference ref = storageRef.child("image"+ calendar.getTimeInMillis() +".png");
                        ...
                        nodeUser.child("email").setValue(user.getEmail());
                        pDialog.dismiss();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == 5 && resultCode == RESULT_OK && data != null && data.getData() != null){
            uri = data.getData();
            Log.d("check dd", uri.getLastPathSegment());
    ...
    private void cancel(){
        btnImgCancelPersonalPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                chBoxEditPersonalPage.setBackground(getDrawable(R.drawable.ic_svg_edit_24));
                chBoxEditPersonalPage.setChecked(false);
                btnImgCancelPersonalPage.setImageDrawable(null);
                edtNamePersonalPage.setEnabled(false);
                spnGenderPersonalPage.setEnabled(false);
