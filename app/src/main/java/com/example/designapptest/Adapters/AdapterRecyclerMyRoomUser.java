...
public class AdapterRecyclerMyRoomUser extends RecyclerView.Adapter<AdapterRecyclerMyRoomUser.ViewHolder> {
    ...
    public AdapterRecyclerMyRoomUser(Context context, List<RoomModel> RoomModelList, int resource) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView txtTimeCreated, txtName,txtAddress,txtQuantityViews,txtQuantityComment, loadings;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            toool = (LinearLayout) itemView.findViewById(R.id.toool);
            txtAddress = (TextView) itemView.findViewById(R.id.txt_address);
            loadings = (TextView) itemView.findViewById(R.id.loadings);
    ...
    @NonNull
    @Override
    public AdapterRecyclerMyRoomUser.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterRecyclerMyRoomUser.ViewHolder viewHolder, int i) {
        ...
        if(roomModel.isApprove()){
            viewHolder.toool.setVisibility(View.VISIBLE);
            viewHolder.loadings.setVisibility(View.GONE);
        }else {
            viewHolder.loadings.setVisibility(View.VISIBLE);
            viewHolder.toool.setVisibility(View.GONE);
        }
